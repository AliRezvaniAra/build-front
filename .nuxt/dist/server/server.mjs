import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, inject as inject$1, toRef, warn, watchEffect, capitalize, shallowRef, Fragment, ref, computed, unref, provide, defineComponent as defineComponent$1, toValue, createVNode, mergeProps, createElementVNode, normalizeClass, h, isReadonly, isRef, isShallow, isReactive, toRaw, watch, onScopeDispose, toRefs, defineAsyncComponent, Suspense, nextTick, createElementBlock, withCtx, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "C:/nuxt/codentral/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/nuxt/codentral/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/nuxt/codentral/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "C:/nuxt/codentral/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { defu } from "C:/nuxt/codentral/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, parseURL, encodePath, decodePath, isScriptProtocol } from "C:/nuxt/codentral/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-mPLmzOP9.js")
  },
  {
    name: "lang",
    path: "/:lang()",
    component: () => import("./_nuxt/index-Na7lx_Vd.js")
  },
  {
    name: "lang-slug",
    path: "/:lang()/:slug()",
    component: () => import("./_nuxt/_slug_-DwMCBQlK.js")
  },
  {
    name: "lang-basket",
    path: "/:lang()/basket",
    component: () => import("./_nuxt/basket-BDH1Tdjz.js")
  },
  {
    name: "lang-favorites",
    path: "/:lang()/favorites",
    component: () => import("./_nuxt/favorites-D9i8Pk2L.js")
  },
  {
    name: "lang-pre2-slug",
    path: "/:lang()/:pre2()/:slug()",
    component: () => import("./_nuxt/_slug_-Dosr3Wgv.js")
  },
  {
    name: "lang-products-slug",
    path: "/:lang()/products/:slug()",
    component: () => import("./_nuxt/_slug_-Cb325XqD.js")
  }
];
...
function vuetifyConfiguration() {
  const options = { "display": { "mobileBreakpoint": "md", "thresholds": { "md": 960 } }, "ssr": true };
  return options;
}
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-CA3o0vBu.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-C6HbugGc.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-C1sUfBy8.js"));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./_nuxt/island-renderer-wYiU2KEx.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
    nuxtApp.deferHydration();
...
export {
  templateRef as $,
  useProxiedModel as A,
  findChildrenWithProvide as B,
  consoleWarn as C,
  wrapInArray as D,
  useTheme as E,
  useIcon as F,
  flattenFragments as G,
  clamp as H,
  IconValue as I,
  useToggleScope as J,
  hasEvent as K,
  isObject as L,
  onlyDefinedProps as M,
  acceleratedEasing as N,
  deceleratedEasing as O,
  ...
  isClickInsideElement as a2,
  getNextElement as a3,
  pick as a4,
  asyncDataDefaults as a5,
  useLocale as a6,
  pickWithRest as a7,
  useRoute as a8,
  makeDisplayProps as a9,
  useGoTo as aa,
  keys as ab,
  __nuxt_component_0 as ac,
  refElement as ad,
  callEvent as ae,
  filterInputAttrs as af,
  createRange as ag,
  keyValues as ah,
  ...
  useRtl as k,
  breakpoints as l,
  getCurrentInstanceName as m,
  navigateTo as n,
  destructComputed as o,
  propsFactory as p,
  isCssColor as q,
  resolveRouteObject as r,
  isParsableColor as s,
  parseColor as t,
  useNuxtApp as u,
  getForeground as v,
  makeThemeProps as w,
