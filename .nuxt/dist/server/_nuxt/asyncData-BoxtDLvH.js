                          ...
                          if (_push4) {
                            ...
                            ssrRenderList(column.elements, (element) => {
                                        ...
                                        _push5(ssrRenderComponent(VBtn, {
                                          ...
                                          default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                            if (_push6) {
                                              ...
                                              if (!element.data.icon) {
                                                _push6(`<span style="${ssrRenderStyle({ "padding-top": "2px" })}" data-v-71b4d819${_scopeId5}>${ssrInterpolate(element.data.buttonTitle)}</span>`);
                                              } else {
                                                _push6(`<!---->`);
                                              }
                                            } else {
                              ...
                              if (element.element_key === "Menu") {
                                _push4(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row" })}" data-v-71b4d819${_scopeId3}><!--[-->`);
                                        ...
                                        if (_push5) {
                                          _push5(ssrRenderComponent(VBtn, mergeProps({ ref_for: true }, props2, {
                                            ...
                                            default: withCtx((_4, _push6, _parent6, _scopeId5) => {
                                              if (_push6) {
                                                _push6(`<span data-v-71b4d819${_scopeId5}>${ssrInterpolate(item.title)}</span>`);
                              ...
                              if (element.element_key === "Logo" && element.data.link !== "") {
                                _push4(ssrRenderComponent(_component_router_link, {
                                  ...
                                  default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                    if (_push5) {
                                      _push5(`<img${ssrRenderAttr("src", unref(config).public.baseUrl + "/" + (__props.theme === "dark" ? element.data.imageFile : element.data.imageFile2))}${ssrRenderAttr("height", element.data.height)}${ssrRenderAttr("alt", element.data.alt)} style="${ssrRenderStyle({ borderRadius: element.data.borderRadius })}" width="auto" data-v-71b4d819${_scopeId4}>`);
                                    } else {
                                      return [
                                        createVNode("img", {
                              ...
                              if (element.element_key === "Languages") {
                                _push4(`<div style="${ssrRenderStyle({ float: unref(direction) === "rtl" ? "left" : "right" })}" data-v-71b4d819${_scopeId3}>`);
...
const RenderHeader = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$e, [["__scopeId", "data-v-71b4d819"]]), { __name: "EditorElementsRenderHeader" });
                          ...
                          default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              ...
                              ssrRenderList(column.elements, (element) => {
                                _push4(`<!--[-->`);
                                if (element.element_key === "Languages") {
                                  _push4(`<div data-v-dfd294de${_scopeId3}>`);
                                  _push4(ssrRenderComponent(VMenu, { style: { "position": "relative", "z-index": "9999" } }, {
                                    activator: withCtx(({ props: props2 }, _push5, _parent5, _scopeId4) => {
                                      if (_push5) {
                                        _push5(ssrRenderComponent(VBtn, mergeProps({
                            ...
                            if (_push4) {
                              ...
                              ssrRenderList(column.elements, (element) => {
                                ...
                                if (element.element_key === "Logo") {
                                  _push4(`<div style="${ssrRenderStyle({ "text-align": "center" })}" data-v-dfd294de${_scopeId3}>`);
                                  if (element.element_key === "Logo" && element.data.link !== "") {
                                    _push4(ssrRenderComponent(_component_router_link, {
                                      to: "/",
                                      ...
                                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                        if (_push5) {
                                          _push5(`<img${ssrRenderAttr("src", unref(config).public.baseUrl + "/" + (__props.theme === "dark" ? element.data.imageFile : element.data.imageFile2))} height="38px"${ssrRenderAttr("alt", element.data.alt)} style="${ssrRenderStyle({ marginTop: "8px", borderRadius: element.data.borderRadius })}" width="auto" data-v-dfd294de${_scopeId4}>`);
                                        } else {
                                          return [
                                            createVNode("img", {
                                              src: unref(config).public.baseUrl + "/" + (__props.theme === "dark" ? element.data.imageFile : element.data.imageFile2),
...
const RenderHeaderMobile = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$c, [["__scopeId", "data-v-dfd294de"]]), { __name: "EditorElementsRenderHeaderMobile" });
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_router_link = resolveComponent("router-link");
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "content position-relative" }, _attrs))} data-v-cb302e4f><div class="left-border position-absolute" data-v-cb302e4f><div class="neon reverse-fa" style="${ssrRenderStyle("background: " + __props.gradient)}" data-v-cb302e4f></div></div><div class="body-content" data-v-cb302e4f>`);
...
const LightGradientFullContent = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$7, [["__scopeId", "data-v-cb302e4f"]]), { __name: "EditorElementsElementsLightGradientFullContent" });
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_router_link = resolveComponent("router-link");
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "content position-relative" }, _attrs))} data-v-f65f40e9><div class="left-border position-absolute" data-v-f65f40e9><div class="neon reverse-fa" style="${ssrRenderStyle("background: " + __props.gradient)}" data-v-f65f40e9></div></div><div class="body-content" data-v-f65f40e9>`);
...
const LightGradientFullContentReverse = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$6, [["__scopeId", "data-v-f65f40e9"]]), { __name: "EditorElementsElementsLightGradientFullContentReverse" });
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", __props.image)}${ssrRenderAttr("height", __props.imageHeight)} class="image" style="${ssrRenderStyle({
              ...
              objectFit: "cover",
              display: "block"
            })}" fetchpriority="high" loading="lazy" decoding="async"${ssrRenderAttr("alt", __props.title)} data-v-875c7bb2${_scopeId}>`);
            _push2(ssrRenderComponent(VCardText, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h4 style="${ssrRenderStyle({ color: __props.buttonColor })}" class="${ssrRenderClass(`text-h6  font-weight-regular mt-2 ${__props.fullTitle.toString() == "false" ? "title" : ""}`)}" data-v-875c7bb2${_scopeId2}>${__props.title ?? ""}</h4>`);
                  if (__props.subTitle !== "") {
                    _push3(`<span style="${ssrRenderStyle({ color: __props.buttonColor, opacity: 0.6 })}" class="text-caption font-weight-light" data-v-875c7bb2${_scopeId2}>${ssrInterpolate(__props.subTitle)}</span>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`<div class="text-body-2 mt-2 pb-4 font-weight-regular" data-v-875c7bb2${_scopeId2}>`);
                  ssrRenderSlot(_ctx.$slots, "default", {}, null, _push3, _parent3, _scopeId2);
                  _push3(`</div>`);
                } else {
                  return [
...
const SimpleCard = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["__scopeId", "data-v-875c7bb2"]]), { __name: "EditorElementsElementsSimpleCard" });
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (__props.element.element_key === "Image") {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "image-wrapper" }, _attrs))} data-v-fd5a92cc>`);
...
const ImageFeature = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-fd5a92cc"]]);
...
const __nuxt_component_1_lazy = defineAsyncComponent(() => import("./DynamicTable-BkSdDaik.js").then((c) => c.default || c));
const __nuxt_component_2_lazy = defineAsyncComponent(() => import("./AdvancedDesktopSlider-BaXWEFDV.js").then((c) => c.default || c));
const __nuxt_component_3_lazy = defineAsyncComponent(() => import("./Team-B2DRav_Q.js").then((c) => c.default || c));
const __nuxt_component_4_lazy = defineAsyncComponent(() => import("./AdvancedSlider-trY7G96n.js").then((c) => c.default || c));
const __nuxt_component_5_lazy = defineAsyncComponent(() => import("./renderForm-CyJcRg8i.js").then((c) => c.default || c));
const __nuxt_component_6_lazy = defineAsyncComponent(() => import("./tileImage-BVE2ID_1.js").then((c) => c.default || c));
const __nuxt_component_7_lazy = defineAsyncComponent(() => import("./modernSlider-DcomAmUu.js").then((c) => c.default || c));
const __nuxt_component_8_lazy = defineAsyncComponent(() => import("./ProductsAndCategories-DCygoNIS.js").then((c) => c.default || c));
const __nuxt_component_9_lazy = defineAsyncComponent(() => import("./ProductsByIds-C8kX6cUh.js").then((c) => c.default || c));
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const shouldOffsetForHeader = computed(() => {
      if (props.is_footer) return false;
      return props.marginTop !== null && props.marginTop !== void 0;
    });
    const parseCssPx = (value) => {
      const n = parseFloat(value);
      return Number.isFinite(n) ? n : 0;
    };
    const firstRowMarginTop = computed(() => {
      if (!shouldOffsetForHeader.value || headerHeight.value <= 0) return "unset";
      const offsetPx = headerHeight.value - parseCssPx(props.marginTop);
      return `${-offsetPx}px`;
    });
    let headerMeasureTimeouts = [];
    const clearHeaderMeasureTimeouts = () => {
      headerMeasureTimeouts.forEach((id) => clearTimeout(id));
      headerMeasureTimeouts = [];
    };
    const unbindHeaderMeasuring = () => {
      clearHeaderMeasureTimeouts();
      headerHeight.value = 0;
    };
    const bindHeaderMeasuring = () => {
      unbindHeaderMeasuring();
      return;
    };
    watch([shouldOffsetForHeader, mdAndUp], async () => {
      await nextTick();
      bindHeaderMeasuring();
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "handle-width" }, _attrs))} data-v-746cecbc><!--[-->`);
      ssrRenderList(__props.rows, (row, index) => {
        _push(ssrRenderComponent(VContainer, {
          fluid: row.container === "fluid" || row.container === "fluid-normal",
          class: index === 0 && shouldOffsetForHeader.value ? "mobile-margin-top" : "",
          style: { padding: 0, marginTop: index === 0 ? firstRowMarginTop.value : "unset" }
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(ContainerBox, {
                  ...
                  if (_push3) {
                    ...
                    ssrRenderList(row.columns, (column) => {
                      _push3(ssrRenderComponent(VCol, {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<div style="${ssrRenderStyle([{ "position": "relative", "display": "flex", "flex-direction": "column", "flex": "1", "height": "100%" }, { padding: column.gap ?? "8px" }])}" data-v-746cecbc${_scopeId3}><div class="${ssrRenderClass(column.animation ? `reveal ${column.animation}` : "")}" style="${ssrRenderStyle({ borderRadius: column.styles?.borderRadius, flex: column.animation !== "fade-in-blur" ? 1 : "unset", display: "flex", flexDirection: "column", position: "relative", width: "100%", height: "100%" })}" data-v-746cecbc${_scopeId3}><div style="${ssrRenderStyle([{ "height": "100%" }, getColumnInnerStyles(column)])}" data-v-746cecbc${_scopeId3}><!--[-->`);
                            ssrRenderList(column.elements, (element) => {
                              _push4(`<div style="${ssrRenderStyle([{ position: "relative", display: "flex", flexDirection: "column" }, getElementPadding(element), { flex: element.element_key === "BorderGradientCard" ? column.animation !== "fade-in-blur" ? 1 : "unset" : element.data?.height === "full" ? 1 : "unset" }])}" class="${ssrRenderClass(element.animation ? `reveal ${element.animation}` : "")}" data-v-746cecbc${_scopeId3}>`);
                              if (element.element_key === "LightGradientAndContents" && !element.data.reverse) {
                                _push4(ssrRenderComponent(LightGradientFullContent, {
                                  ...
                                  default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                    if (_push5) {
                                      _push5(`<div class="pa-4" data-v-746cecbc${_scopeId4}>${element.data.content ?? ""}</div>`);
                                    } else {
                                      return [
                                        createVNode("div", {
                                          class: "pa-4",
                              ...
                              if (element.element_key === "SimpleContent") {
                                _push4(`<div data-v-746cecbc${_scopeId3}>${element.data.content ?? ""}</div>`);
                              } else {
                                _push4(`<!---->`);
                              }
                              if (element.element_key === "Button") {
                                        ...
                                        _push5(ssrRenderComponent(VBtn, {
                                          ...
                                          default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                            if (_push6) {
                                              ...
                                              if (!element.data.icon) {
                                                _push6(`<span style="${ssrRenderStyle({ "padding-top": "2px" })}" data-v-746cecbc${_scopeId5}>${ssrInterpolate(element.data.buttonTitle)}</span>`);
                                              } else {
                                                _push6(`<!---->`);
                                              }
                                            } else {
                              ...
                              if (element.element_key === "BackgroundAndGradientCard") {
                                _push4(`<div style="${ssrRenderStyle({ "width": "100%" })}" data-v-746cecbc${_scopeId3}>`);
                                    ...
                                    default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                      if (_push5) {
                                        ...
                                        _push5(ssrRenderComponent(Flex, {
                                          ...
                                          default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                            if (_push6) {
                                              _push6(`<div class="px-4" data-v-746cecbc${_scopeId5}>${element.data.content ?? ""}</div>`);
                                            } else {
                                              return [
                                                createVNode("div", {
                                                  class: "px-4",
                              ...
                              if (element.element_key === "SimpleCard") {
                                _push4(ssrRenderComponent(SimpleCard, {
                                  ...
                                  default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                    if (_push5) {
                                      _push5(`<div data-v-746cecbc${_scopeId4}>${element.data.content ?? ""}</div>`);
                                    } else {
                                      return [
                                        createVNode("div", {
                                          innerHTML: element.data.content
                              ...
                              if (element.element_key === "BorderGradientCard") {
                                _push4(`<div style="${ssrRenderStyle({ "flex": "1", "display": "flex", "flex-direction": "column" })}" data-v-746cecbc${_scopeId3}>`);
                                _push4(ssrRenderComponent(_component_LazyEditorElementsElementsGradientCard, {
                                  ...
                                  default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                    if (_push5) {
                                      _push5(`<div class="d-flex flex-column ga-2 align-center" style="${ssrRenderStyle({ "flex": "1" })}" data-v-746cecbc${_scopeId4}>`);
                                      ...
                                      if (element.data.iconType === "Image" && element.data.iconFile) {
                                        _push5(`<img${ssrRenderAttr("alt", element.data.content)} style="${ssrRenderStyle({ "background-size": "contain", "height": "48px", "width": "48px" })}"${ssrRenderAttr("src", `${unref(config).public.baseUrl}/${element.data.iconFile}`)} loading="lazy" decoding="async" data-v-746cecbc${_scopeId4}>`);
                                      } else {
                                        _push5(`<!---->`);
                                      }
                                      _push5(`<div style="${ssrRenderStyle({ "flex": "1" })}" data-v-746cecbc${_scopeId4}>${element.data.content ?? ""}</div>`);
                                      if (element.data.buttonTitle) {
                                          ...
                                          default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                            if (_push6) {
                                              ...
                                              _push6(ssrRenderComponent(VExpansionPanelText, null, {
                                                default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                                  if (_push7) {
                                                    _push7(`<div class="px-3" data-v-746cecbc${_scopeId6}>${item.description ?? ""}</div>`);
                                                  } else {
                                                    return [
                                                      createVNode("div", {
                                                        class: "px-3",
                              ...
                              if (element.element_key === "AdvancedSlider") {
                                _push4(`<div style="${ssrRenderStyle({ "width": "100%", "position": "relative" })}" data-v-746cecbc${_scopeId3}>`);
...
const Render = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-746cecbc"]]), { __name: "EditorElementsRender" });
...
//# sourceMappingURL=asyncData-BoxtDLvH.js.map
