...
import { l as useShopLocal, u as useAsyncData, H as Header1, a as Header1Mobile, V as VContainer, k as VIcon, n as VBtn, p as VRow, q as VCol, r as VCard, s as VImg, w as VProgressCircular, x as VCardText, y as VCardActions, R as Render } from "./asyncData-BoxtDLvH.js";
...
import { V as VChip } from "./VChip-BJSXa4x6.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(VContainer, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<header class="d-flex align-end justify-space-between mb-10" data-v-120a712b${_scopeId}><div data-v-120a712b${_scopeId}><h1 class="text-h3 font-weight-black mb-1" data-v-120a712b${_scopeId}>${ssrInterpolate(unref(t).favorites?.title)}</h1><p class="text-body-1 text-medium-emphasis" data-v-120a712b${_scopeId}>${ssrInterpolate(unref(t).favorites?.subtitle)}</p></div>`);
            ...
            _push2(`</header>`);
            if (!unref(favorites2).length) {
              _push2(`<div class="text-center py-16" data-v-120a712b${_scopeId}>`);
              ...
              _push2(`<h2 class="text-h5 text-medium-emphasis mb-6" data-v-120a712b${_scopeId}>${ssrInterpolate(unref(t).favorites?.empty_title)}</h2>`);
                        ...
                        if (_push4) {
                          _push4(ssrRenderComponent(VCard, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="image-container overflow-hidden" data-v-120a712b${_scopeId4}>`);
                                ...
                                _push5(ssrRenderComponent(VCardText, { class: "pt-4 pb-2 px-4 flex-grow-1" }, {
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<div class="d-flex justify-space-between align-start mb-1" data-v-120a712b${_scopeId5}><span class="text-caption font-weight-medium text-disabled" data-v-120a712b${_scopeId5}>SKU: ${ssrInterpolate(item.sku)}</span></div><h3 class="text-h6 font-weight-bold text-truncate mb-1" data-v-120a712b${_scopeId5}>${ssrInterpolate(item.title)}</h3><div class="text-h6 color-primary font-weight-black" data-v-120a712b${_scopeId5}><span class="text-body-2 font-weight-medium" data-v-120a712b${_scopeId5}>${ssrInterpolate(item.currency)}</span> ${ssrInterpolate(parseFloat(item.price).toLocaleString())}</div>`);
                                    } else {
                                      return [
...
const favorites = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-120a712b"]]);
export {
  favorites as default
};
//# sourceMappingURL=favorites-D9i8Pk2L.js.map
