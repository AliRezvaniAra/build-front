...
import { R as Render } from "./asyncData-BoxtDLvH.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><div id="height-according-container" style="${ssrRenderStyle({ height: dynamicHeight.value })}" data-v-ae4bcd40></div><div class="fullpage-slider" id="slider-container" style="${ssrRenderStyle({ height: dynamicHeight.value, borderRadius: __props.radius, direction: "ltr" })}" data-v-ae4bcd40>`);
      if (!!__props.slidesData[0] && __props.mode === "single-content") {
        _push(`<div class="slider-overlay" data-v-ae4bcd40>`);
                  ...
                  if (_push3) {
                    if (slide.image) {
                      _push3(`<div class="${ssrRenderClass(`slide ${__props.hoverEffect}`)}"${ssrRenderAttr("id", `slide${index}`)} style="${ssrRenderStyle({
                        ...
                        padding: "16px"
                      })}" data-v-ae4bcd40${_scopeId2}><picture style="${ssrRenderStyle({ "position": "absolute", "left": "0", "top": "0", "width": "100%", "height": "100%" })}" data-v-ae4bcd40${_scopeId2}><source media="(max-width: 960px)"${ssrRenderAttr("srcset", unref(config).public.baseUrl + "/" + (slide.imageMobile || slide.image))} data-v-ae4bcd40${_scopeId2}><img${ssrRenderAttr("src", unref(config).public.baseUrl + "/" + slide.image)} style="${ssrRenderStyle({ "object-fit": "cover", "width": "100%", "height": "100%" })}" alt="Codentral" data-v-ae4bcd40${_scopeId2}></picture><div class="overlay" style="${ssrRenderStyle({
                        background: `linear-gradient(${slide.gradColor1}, ${slide.gradColor2}, ${slide.gradColor3})`
                      })}" data-v-ae4bcd40${_scopeId2}></div>`);
...
const AdvancedSlider = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-ae4bcd40"]]), { __name: "EditorElementsElementsAdvancedSlider" });
export {
  AdvancedSlider as default
};
//# sourceMappingURL=AdvancedSlider-trY7G96n.js.map
